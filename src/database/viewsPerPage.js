...
const aggregateViewsPerPage = require('../aggregations/aggregateViewsPerPage')
...
const get = async (ids, page, type, interval, limit, dateDetails) => {

	const aggregation = (() => {

		if (type === constants.VIEWS_TYPE_UNIQUE) return aggregateViewsPerPage(ids, page, true, interval, limit, dateDetails)
		if (type === constants.VIEWS_TYPE_TOTAL) return aggregateViewsPerPage(ids, page, false, interval, limit, dateDetails)
